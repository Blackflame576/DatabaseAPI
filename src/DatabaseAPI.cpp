...
DB::EnumColDatabaseValues DB::Database::GetOneColumnFromTable(const std::string &NameTable, const std::string &NameColumn, const std::optional<DatabaseValues> &Parameters)
{
    // int num_columns;
    int RESULT_SQL;
